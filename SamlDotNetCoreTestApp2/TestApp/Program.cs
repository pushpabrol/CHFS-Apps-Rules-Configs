...
builder.Services.Configure<CookiePolicyOptions>(options =>
{
    ...
    //options.OnAppendCookie = (Microsoft.AspNetCore.CookiePolicy.AppendCookieContext obj) =>
    //{
...
builder.Services.ConfigureApplicationCookie(options =>
{
    ...
    options.Cookie.Name = "SamlTestApp2.Identity";
...
//    options.CookieName = "samltestapp2-saml-session";
...
{
    options.Cookie.SameSite = SameSiteMode.None;
    options.Cookie.Name = "SamlTestApp2";
